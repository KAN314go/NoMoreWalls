...
class Spider(Spider):
    ...
    def __init__(self):
        ...
        # 取得當前 py 檔案所在目錄，用來定位 json 檔案
        self.base_dir = os.path.dirname(os.path.abspath(__file__))
        self.channels_json_path = os.path.join(self.base_dir, 'channels.json')
        self.extra_json_path = os.path.join(self.base_dir, 'extra.json')
    ...
    def load_channels(self):
        ...
        for d in possible_dirs:
            c_path = os.path.join(d, 'channels.json')
            e_path = os.path.join(d, 'extra.json')
            
            for json_file in [c_path, e_path]:
